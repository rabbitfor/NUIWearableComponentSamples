...
{
    /// <summary>
    /// Describes Bottom Button in OneUI_Watch2.X
    /// </summary>
    public class BottomButtonStyle : StyleBase
    {

        /// <summary>
        /// Describes Bottom Button in OneUI_Watch2.X
        /// </summary>
        public static ButtonStyle GetStyle()
        {
        ...
        /// <summary>
        /// This method is for StyleManager
        /// </summary>
        protected override ViewStyle GetAttributes()
        {
            return (ViewStyle)GetStyle();
        }
    }
}
